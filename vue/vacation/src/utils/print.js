...
Print.prototype = {
  ...
  wrapperRefDom: function (refDom) {
    let prevDom = null
    let currDom = refDom
    // Determines whether the current element is present body In the,不在文档In the则直接返回该节点
  ...
  writeIframe: function (content) {
    ...
    iframe.setAttribute('style', 'width:2800px;height:2800px;top:-10px;left:-10px;');
