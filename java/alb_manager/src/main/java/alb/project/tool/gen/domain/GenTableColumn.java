...
public class GenTableColumn extends BaseEntity
{
    ...
    /** A query(EQIs equal to the、NE不Is equal to the、GTIs greater than、LTLess than、LIKEThe fuzzy、BETWEENThe scope of) */
    ...
    {
        // isSuperColumn()The list is used to avoid generating excessDomainattribute,若某些attribute在生成页面时需要用到不能忽略,It is whitelisted here
