...
/**
 * Reflection tool class. Provide callgetter/settermethods, Accessing private variables, 调用私有methods, Gets the generic typeClass, beAOPUtility functions such as real classes.
 *
 */
...
public class ReflectUtils
{
    ...
    public static <E> E invokeMethodByName(final Object obj, final String methodName, final Object[] args)
    {
        ...
        try
        {
            // Type conversion(将参数数据Type conversion为目标方法参数类型)
